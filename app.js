...
window.addEventListener("scroll",()=>{
    ...
    authorname.style.transform = `translateX(${offsetY * 0.15}px)`;
    ...
    // projectsTitle.style.transform = `translateY(calc(396vh - ${offsetY}px))`;
    // laptop.style.transform = `translateX(calc((200vh) - ${offsetY}px)))`;
